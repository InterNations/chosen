...
(function() {
  ...
  SelectParser.select_to_array = function(select, settings) {
...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      this.enable_query_hinting = !!this.options.enable_query_hinting;
...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      var container_classes, container_props, footer;
      ...
      if (this.options.render_footer) {
        footer = $(this.options.render_footer()).bind("click", function(e) {
    ...
    Chosen.prototype.winnow_results = function() {
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        ...
        if (option.group) {
          ...
          if (found) {
            if (this.enable_query_hinting && query.length) {
